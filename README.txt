...
- Novo assistente visual “Guardião GSP”, com recortes específicos para a tela principal e para o painel de ajuda.
...
- app.js: funcionamento, IndexedDB, assistente e Google Sheets.
...
- assets/guardiao-gsp-hero.webp: imagem principal do Guardião.
- assets/guardiao-gsp-avatar.webp: avatar do Guardião no botão e no painel de ajuda.
