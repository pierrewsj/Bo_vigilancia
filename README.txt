BO DIGITAL GSP — v35.0.0


ATUALIZAÇÃO v35 — FLUXO ADAPTATIVO E SUBMODELOS OPERACIONAIS

A v35 reorganiza o preenchimento para reduzir repetições e exigir somente informações coerentes com o tema selecionado. Os 41 tipos principais foram preservados e situações históricas passaram a funcionar como submodelos operacionais.

Rondas interna e externa não possuem solicitante. O vigilante responsável, registro e turno são obtidos da sessão de login e passam a ser parte obrigatória do registro da ronda.

Documentos, quantidades, identificação técnica, danos de veículo e evidências fotográficas agora utilizam regras contextuais. Consulte ALTERACOES_V35.txt para a lista completa.
