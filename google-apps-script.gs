/**
 * BO DIGITAL GSP — Google Sheets API v6.2.0 — revisão profissional e estrutura compacta
 *
...
const SCRIPT_REVISION = 'v26-revisao-taxonomia';
...
function doPost(e) {
  ...
  try {
    ...
    if (action === 'login') {
      ...
      SpreadsheetApp.flush();
      return json_({
        ok:true, version:APP_VERSION, schema:'compact-t', operatorSaved:true,
